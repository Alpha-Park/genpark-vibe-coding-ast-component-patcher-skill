# genpark-vibe-coding-ast-component-patcher-skill
...
**genpark-vibe-coding-ast-component-patcher-skill** is a deterministic, zero-dependency Python skill engineered for autonomous full-stack vibe coding, AST-level frontend component patching, and hydration exception triage.

> **Executive Capability**: AST-level React JSX component and Tailwind CSS patcher (Lovable.dev / Bolt)
...
result = client.patch_react_component()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-vibe-coding-ast-component-patcher-skill": {
      "command": "python",
      "args": ["/path/to/genpark-vibe-coding-ast-component-patcher-skill/mcp_server.py"]
    }
  }
}
```
